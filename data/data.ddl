...
INSERT INTO category(categoryName) VALUES ('Ducks');

INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Emo Orphan Duck', 9, 'His parents are dead.',18.00, 'public/images/Ducks/batDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Murderer Duck', 9, 'You just know he did it.',19.00, 'public/images/Ducks/butlerDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('College Dropout Duck', 9, 'Drop the beak!',10.00, 'public/images/Ducks/djDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Hon Hon Duck', 9, 'Oui oui, baguette!',20.00, 'public/images/Ducks/frenchDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Steroid Duck', 9, 'Duck, smash!',18.00, 'public/images/Ducks/hulkDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Super Copper Duck', 9, 'Just an asshole with WAY too much money.',22.00, 'public/images/Ducks/ironDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Holy Duck', 9, 'Kinda looks like Jesus, right?',1.00, 'public/images/Ducks/jesusDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Meth Duck', 9, 'He just needs a taste, alright?',25.00, 'public/images/Ducks/methDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Doubloon Duck', 9, 'Not associated with that dumb TikTok trend.',2.00, 'public/images/Ducks/pirateDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('The Artist Formerly Known as Duck', 9, 'Purple rain and little red corvettes, baby!',42.00, 'public/images/Ducks/princeDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Legalize It Duck', 9, 'He just wants your ganja!',18.00, 'public/images/Ducks/reggaeDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Spooky Tongue Duck', 9, 'You do NOT want him to open his mouth. Trust me.',19.00, 'public/images/Ducks/rockDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Dumb Duck', 9, 'No brains. Only hay.',18.00, 'public/images/Ducks/scarecrowDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Sticky Duck', 9, 'He got bit by a bug and it kinda worked out for him.',8.00, 'public/images/Ducks/spiderDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Spuck', 9, 'Live long and consume bread.',18.00, 'public/images/Ducks/spockDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Denim Duck', 9, 'I do not even really know what this one is meant to be...',18.00, 'public/images/Ducks/stonerDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Cool Robot Duck', 9, 'I will be quack.',27.00, 'public/images/Ducks/terminatorDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Not-So-Cool Robot Duck', 9, 'Really? Tin? What a crappy metal.',17.00, 'public/images/Ducks/tinDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('The Dumbest Duck', 9, 'Do not buy this one. Seriously, it sucks.',40.00, 'public/images/Ducks/trumpDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Oily Duck', 9, 'America! Duck yeah!',200.00, 'public/images/Ducks/usaDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Sad Mask Duck', 9, 'He is your daddy.',24.00, 'public/images/Ducks/vaderDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Ugly Duck', 9, 'Not THAT ugly duck. I think that was a duckling.',66.00, 'public/images/Ducks/witchDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Magic Trauma Duck', 9, 'The duck that lived. Somehow.',22.00, 'public/images/Ducks/wizardDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Wooden Duck', 9, 'I am Duck.',12.00, 'public/images/Ducks/woodDuck.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Moaning Space Bear Duck', 9, 'DWAAAAAGGHHHHHH!',19.00, 'public/images/Ducks/wookieDuck.png');
